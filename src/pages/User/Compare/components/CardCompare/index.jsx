        ...
        <div className="card-compare">
            <div className="pricing-table">
                ...
                <ul className="pricing-table__list">
                    ...
                    <li className={props.rank.bath === 2 ? "high" : props.rank.bath === 0 ? "low" : ""}>Phòng tắm: {props.item?.bathroom_quantity}</li>
                    <li className={props.rank.floor === 2 ? "high" : props.rank.floor === 0 ? "low" : ""}>Số tầng: {props.item?.floor_quantity}</li>
                    <li className={props.rank.toilet === 2 ? "high" : props.rank.toilet === 0 ? "low" : ""}>Nhà vệ sinh: {props.item?.toilet_quantity}</li>
                    <li>Nội thất: {props.item?.furniture}</li>
                    <li className={props.rank.area === 2 ? "high" : props.rank.area === 0 ? "low" : ""}>Kích thước: {props.item?.area}m2</li>
